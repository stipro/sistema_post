        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form autocomplete="off" class="FormularioAjax" action = "<?php echo SERVERURL;?>proveedor/agregar_proveedor" method="POST" data-form="save" ectype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input name="dnir_agregar" type="text" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
